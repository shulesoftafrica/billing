...
<body>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    ...
                    <h1>Stop paying fees<br>to collect payments.<br><span class="accent">Earn up to 1.5% annually.</span></h1>
                    ...
                    <p class="sub">
                        Safari API pays <strong style="color:#34d399;">1.0% per year</strong> on total annual collections from <strong style="color:#fff;">TZS 250M</strong>, and <strong style="color:#34d399;">1.5% per year</strong> from <strong style="color:#fff;">TZS 1B</strong>. Below TZS 250M, commission is 0. Zero setup fees. Zero transaction charges.
                    </p>
                    <div class="hero-ctas">
                    ...
                    <div class="mt-3 p-3 rounded-3 d-inline-block" style="background:rgba(52,211,153,.06);border:1px solid rgba(52,211,153,.15);font-size:.8rem;color:rgba(255,255,255,.55);">
                        ...
                        A developer collecting <strong style="color:#fff;">TZS 5B per year</strong> earns <strong style="color:#34d399;">TZS 75M</strong> at the 1.5% tier, paid through Safari API.
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-features">
        <div class="container">
            <div class="text-center mb-5">
                <div class="section-eyebrow">Annual Collection Commission</div>
                <div class="section-title">Hit TZS 250M annual collections.<br>Start earning commission.</div>
                <p class="section-sub">Safari API pays commission on your total annual collections: 0% below TZS 250M, 1.0% from TZS 250M to TZS 999,999,999, and 1.5% from TZS 1B and above.</p>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="feature-card">
                        ...
                        <h5>Tiered Annual Commission</h5>
                        <p>Earn 1.0% commission when annual collections reach TZS 250M, and 1.5% once annual collections reach TZS 1B. Below TZS 250M, commission is 0.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="feature-card">
                        ...
                        <p>Start with zero setup fees and zero transaction charges. Integrate once and begin processing collections immediately.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="feature-card">
            ...
            <div class="row align-items-start justify-content-center">
                ...
                <div class="col-6 col-md-3">
                    <div class="step-card">
                        ...
                        <h6>Collections Earn For You</h6>
                        <p>Once your annual collections reach TZS 250M you earn 1.0%, and once they hit TZS 1B you earn 1.5%. Your integration doesn&rsquo;t just work. It generates revenue.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="section-calc" id="pricing">
        <div class="container">
            <div class="text-center mb-5">
                <div class="section-eyebrow" style="color:#93c5fd;">Annual Commission Calculator</div>
                <div class="section-title" style="color:#fff;">Calculate your annual commission.</div>
                <p class="section-sub" style="color:rgba(255,255,255,.5);">Set your total annual collections. Commission is <strong style="color:#34d399;">0%</strong> below TZS 250M, <strong style="color:#34d399;">1.0%</strong> from TZS 250M, and <strong style="color:#34d399;">1.5%</strong> from TZS 1B.</p>
            </div>
            ...
            <div class="story-callout">
                ...
                <div>
                    <h5>How one integration earns TZS 75M on TZS 5B annual collections.</h5>
                    <p>
                        A Tanzanian startup collecting <strong style="color:#fff;">TZS 5B annually</strong> earns <span class="sc-number">TZS 75,000,000</span> in commission at the 1.5% tier. Use the calculator below to run your own numbers.
                    </p>
                </div>
            </div>
            <div class="calc-card">
                <div class="mb-4">
                    <label class="d-flex justify-content-between">
                        <span>Total Annual Collections</span>
                        <span style="color:#60a5fa;font-weight:700;font-family:'IBM Plex Mono',monospace;"
                            id="volumeDisplay">TZS 5,000,000,000</span>
                    </label>
                    <input type="range" class="calc-range mt-2" id="volumeSlider" min="50000000" max="50000000000"
                        step="500000000" value="5000000000">
                    <div class="d-flex justify-content-between mt-1"
                        style="font-size:.7rem;color:rgba(255,255,255,.3);">
                        <span>TZS 50M</span><span>TZS 50B</span>
                    </div>
                </div>

                <div class="calc-result">
                    <div class="result-label">Estimated annual commission</div>
                    <div class="result-value" id="commissionResult">TZS 0</div>
                    <div class="result-sub" id="calcSub">rate: 1.5% on TZS 5,000,000,000 annual collections</div>
                </div>
                <div class="calc-compare">
                    <div class="comp-item">
                        <div class="comp-label">Your annual commission</div>
                        <div class="comp-value comp-positive" id="earnValue">+ TZS 100,000</div>
                    </div>
                    <div class="comp-item">
                        <div class="comp-label">Rate tier</div>
                        <div class="comp-value" id="tierLabel" style="color:#93c5fd;">1.5% p.a.</div>
                    </div>
                    <div class="comp-item">
                        <div class="comp-label">Minimum qualifying annual collections</div>
                        <div class="comp-value" style="color:#fbbf24;">TZS 250,000,000</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-6 col-lg-3">
                    ...
                    <span class="footer-link" style="cursor:default;">Mastercard Foundation</span>
    ...
    <script>
        ...
        function updateCalc() {
            ...
            document.getElementById('calcSub').textContent =
                'rate: ' + ratePercent + '% on ' + fmt(volume) + ' annual collections';
            document.getElementById('earnValue').textContent = '+ ' + fmt(commission);
            document.getElementById('tierLabel').textContent = ratePercent + '% p.a.';
        }
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content" style="background:#0f172a;color:rgba(255,255,255,.82);border:1px solid rgba(255,255,255,.1);">
                ...
                <div class="modal-body" style="font-size:.875rem;line-height:1.8;">
                    ...
                    <p>ShuleSoft Ltd operates a <strong style="color:#fff;">"Liquidity Reward"</strong> (also referred to as a "Platform Rebate" or "Channel Partner Commission") — a technology incentive paid to eligible Third-Party Integrators based on the total annual collections they facilitate through the Safari API. This programme is <strong style="color:#fff;">not an interest-bearing product</strong> and does not constitute a savings scheme or investment product under any applicable Tanzanian financial regulation.</p>

                    <h6 style="color:#34d399;font-weight:700;margin-top:1.25rem;">2a. Tiered Reward Rate Structure</h6>
                    <p>The Liquidity Reward is calculated on the <strong style="color:#fff;">total annual collections</strong> recorded in the developer's integration account. Rates apply on a <em>tiered basis</em> as follows:</p>
                        ...
                        <table style="width:100%;border-collapse:collapse;font-size:.84rem;">
                            <thead>
                                <tr style="background:rgba(96,165,250,.12);">
                                    <th style="padding:.65rem 1rem;text-align:left;color:#60a5fa;font-weight:700;border-bottom:1px solid rgba(255,255,255,.08);">Annual Collection Tier</th>
                            ...
                            <tbody>
                                <tr style="border-bottom:1px solid rgba(255,255,255,.06);">
                                    <td style="padding:.6rem 1rem;color:rgba(255,255,255,.6);">TZS 0 — TZS 249,999,999</td>
                                ...
                                <tr style="border-bottom:1px solid rgba(255,255,255,.06);background:rgba(255,255,255,.02);">
                                    <td style="padding:.6rem 1rem;color:rgba(255,255,255,.85);">TZS 250,000,000 — TZS 999,999,999</td>
                                    <td style="padding:.6rem 1rem;text-align:center;"><span style="color:#fbbf24;font-weight:700;font-family:'IBM Plex Mono',monospace;">1.00% p.a.</span></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:.6rem 1rem;text-align:center;"><span style="color:#34d399;font-weight:700;font-family:'IBM Plex Mono',monospace;">1.50% p.a.</span></td>
                    ...
                    <p style="color:rgba(255,255,255,.55);font-size:.82rem;"><i class="bi bi-info-circle me-1" style="color:#fbbf24;"></i> <strong style="color:#fbbf24;">Example:</strong> A developer collecting TZS 2B annually earns: TZS 2,000,000,000 × 1.5% = <strong>TZS 30,000,000/year</strong>, paid monthly.</p>

                    <h6 style="color:#34d399;font-weight:700;margin-top:1.25rem;">2b. Accrual &amp; Payout Rules</h6>
                    <ul>
                        <li><strong style="color:#fff;">Accrual Basis:</strong> Rewards are computed from total qualifying annual collections per account. Only settled and confirmed collections qualify.</li>
                        <li><strong style="color:#fff;">Annual Formula:</strong> Annual commission = (Qualifying Annual Collections × Applicable Rate).</li>
                        ...
                        <li><strong style="color:#fff;">No Guaranteed Minimum:</strong> ShuleSoft Ltd does not guarantee a minimum monthly reward. Annual collections below TZS 250,000,000 earn zero commission.</li>
                    ...
                    <p>Direct-integration organisations benefit from <strong style="color:#fff;">zero transaction fees</strong> and <strong style="color:#fff;">zero setup fees</strong> as their incentive. The Liquidity Reward shall not be paid on annual collections generated by an organisation's own internal integration.</p>
                    ...
                    <p class="mt-4" style="color:rgba(255,255,255,.32);font-size:.78rem;">By registering and using Safari API, you confirm that you are authorised to bind your organisation to these Terms, that you have read and understood them in full, and that your organisation qualifies as an eligible Third-Party Integrator under Section 3.</p>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content" style="background:#0f172a;color:rgba(255,255,255,.82);border:1px solid rgba(255,255,255,.1);">
                ...
                <div class="modal-body" style="font-size:.875rem;line-height:1.8;">
                    ...
                    <p>ShuleSoft Ltd operates a <strong style="color:#fff;">“Liquidity Reward”</strong> — a technology incentive (also called a “Platform Rebate” or “Channel Partner Commission”) paid to eligible Third-Party Integrators based on the total annual collections they facilitate through the Safari API. This is <strong style="color:#fff;">not an interest-bearing product</strong> and does not constitute a savings scheme or investment product under Tanzanian law.</p>

                    <h6 style="color:#34d399;font-weight:700;margin-top:1.5rem;">Tiered Rate Structure</h6>
                    <p>Rewards are calculated on the <strong style="color:#fff;">total annual collections</strong> in a calendar year, applied on a tiered basis:</p>
                    ...
                    <p style="color:rgba(255,255,255,.55);font-size:.82rem;"><i class="bi bi-info-circle me-1" style="color:#fbbf24;"></i> <strong style="color:#fbbf24;">Example:</strong> TZS 2B annual collections &times; 1.5% = <strong style="color:#fff;">TZS 30,000,000/year</strong>, paid monthly.</p>

                    <h6 style="color:#34d399;font-weight:700;margin-top:1.5rem;">Accrual &amp; Payout Rules</h6>
                    <ul>
                        <li><strong style="color:#fff;">Accrual:</strong> Rewards are computed from annual qualifying collections. Formula: <code style="background:rgba(255,255,255,.07);padding:.1rem .4rem;border-radius:4px;">Annual Collections &times; Rate</code>.</li>
                        ...
                        <li><strong style="color:#fff;">No Guaranteed Minimum:</strong> Annual collections below TZS 250,000,000 earn zero reward.</li>
                    ...
                    <p style="background:rgba(52,211,153,.06);border-left:3px solid #34d399;padding:.75rem 1rem;border-radius:0 6px 6px 0;"><i class="bi bi-check-circle-fill me-2" style="color:#34d399;"></i> <strong style="color:#34d399;">Eligible:</strong> Registered developer <strong style="color:#fff;">organisations (legal entities)</strong> that integrate Safari API on behalf of <strong style="color:#fff;">third-party client organisations</strong> (Independent Software Vendors / Integration Partners).</p>
            ...
            <div class="modal-content" style="background:#0f172a;color:rgba(255,255,255,.82);border:1px solid rgba(255,255,255,.1);">
                ...
                <div class="modal-body" style="font-size:.875rem;line-height:1.8;">
                    ...
                    <ul>
                        ...
                        <li><strong style="color:#fff;">Minimum Threshold:</strong> Annual collections below <strong style="color:#fff;">TZS 250,000,000</strong> earn zero commission (0.00% tier).</li>
