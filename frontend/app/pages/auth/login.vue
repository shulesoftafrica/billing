...
useHead({
  title: 'Sign In - Billing Platform'
})
...
const handleLogin = async () => {
  ...
  try {
    ...
    const isVerified = true // In production, check from API response
    ...
    // Check if onboarding is complete (simulation)
    const hasCompletedOnboarding = false // In production, check from API response
